...
# 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
...
with col1:
    st.markdown(
        "Often professionals would like to improve their emails, but don't have the skills to do so. \n\n This tool \
...
with col2:
    st.image(
        image=r'GUI\streamlit\NLP\LangChain Email Format App\Images\TweetScreenshot.png',
        width=500,
