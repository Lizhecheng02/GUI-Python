...
def on_generate_schedule():
    st.session_state.todo_list = create_schedule(
        st.session_state.habits_df,
        DayOfWeek[st.session_state.day_of_week.upper()],
    )
...
with st.sidebar:
    ...
    if st.session_state.todo_list:
        ...
        st.warning("Your schedule is empty. Generate a schedule to get started.")
